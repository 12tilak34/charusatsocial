...
import 'package:Sahemat/pages/add_lits.dart';
import 'package:Sahemat/helpers/share_service.dart';
import 'package:Sahemat/models/link_to.dart';
import 'package:Sahemat/models/user_info_model.dart';
import 'package:Sahemat/pages/account_settings.dart';
import 'package:Sahemat/pages/appbuilder.dart';
import 'package:Sahemat/pages/audiencepage.dart';
import 'package:Sahemat/pages/bug_report.dart';
import 'package:Sahemat/pages/community_page.dart';
import 'package:Sahemat/pages/contact_page.dart';
import 'package:Sahemat/pages/content_results.dart';
import 'package:Sahemat/pages/debate_screen1.dart';
import 'package:Sahemat/pages/featured_communities.dart';
import 'package:Sahemat/pages/image_page_2.dart';
import 'package:Sahemat/pages/linkpage.dart';
import 'package:Sahemat/pages/lits_timeline_2.dart';
import 'package:Sahemat/pages/nonlive_video_player.dart';
import 'package:Sahemat/pages/podcast_screen1.dart';
import 'package:Sahemat/pages/policies_page.dart';
import 'package:Sahemat/pages/post_image.dart';
import 'package:Sahemat/pages/post_text.dart';
import 'package:Sahemat/pages/postlink.dart';
import 'package:Sahemat/pages/preview_image.dart';
import 'package:Sahemat/pages/preview_text_image.dart';
import 'package:Sahemat/pages/profilepage.dart';
import 'package:Sahemat/pages/qna_screen1.dart';
import 'package:Sahemat/pages/text_content_page.dart';
import 'package:Sahemat/pages/upload_video.dart';
import 'package:Sahemat/pages/videoplayerpage.dart';
import 'package:Sahemat/widgets/featured_live_card.dart';
import 'package:Sahemat/widgets/featured_text_card.dart';
import 'package:Sahemat/widgets/featured_video_card.dart';
import 'package:Sahemat/widgets/featuredlinkcard.dart';
import 'package:Sahemat/widgets/gradient_icon.dart';
import 'package:Sahemat/widgets/updownvotewidget.dart';
          ...
          return WillPopScope(
            ...
            child: AlertDialog(
              ...
              content: (reason == 'maintenance')
                  ? Text(
                      'Sorry for the inconvenience, but Sahemat is undergoing some maintenance. Please check back later! :)',
                      style: Theme.of(context).textTheme.subtitle1!.copyWith(
                            color: Colors.white70,
                            fontSize: 14.0,
                          ))
                  : Text(
                      "A new and improved version of Sahemat is available for download. Please update to continue using the app.",
                      style: Theme.of(context).textTheme.subtitle1!.copyWith(
                            color: Colors.white70,
                            fontSize: 14.0,
                          )),
        ...
        actions: <CupertinoActionSheetAction>[
          CupertinoActionSheetAction(
            ...
            onPressed: () {
              Navigator.pop(context);
              Share.share(
                  "Sahemat is a Indian Political Discussion Platform");
            },
            child: Text(
              'Share App',
              style: Theme.of(context).textTheme.button!.copyWith(
